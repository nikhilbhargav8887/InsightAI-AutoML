...
def home():
    return {
        "message": "Welcome to the Insight AutoML API. Use the available endpoints to upload datasets, clean data, analyze features, train models, and get explanations."
    }